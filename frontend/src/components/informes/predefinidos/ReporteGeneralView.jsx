...
const ReporteGeneralView = ({ data, isInternalReport, onClose }) => {
    if (!data) return null;

    const { plan, metas, counts, totalMetas } = data;
    ...
    return (
        <div className="fixed inset-0 z-50 bg-white overflow-auto">
            ...
            {/* Contenido Imprimible (Hoja A4 aproximada) */}
            <div className="print:w-full max-w-[210mm] mx-auto p-[20mm] bg-white print:p-0 print:m-0">
                ...
                <div className="flex flex-col items-center justify-center break-inside-avoid">
                    <h3 className="text-lg font-bold mb-4">Representación Gráfica</h3>
                    <div className="h-96 w-full max-w-lg relative">
                        {totalMetas === 0 ? (
                            ...
                            <>
                                ...
                                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center pointer-events-none">
                                    <span className="text-4xl font-bold text-gray-700">{totalMetas}</span>
